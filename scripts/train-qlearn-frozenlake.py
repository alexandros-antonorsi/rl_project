...
parser.add_argument("--e_final", help="final exploration rate", type=float, default=0.1)
parser.add_argument("--discount", help="discount rate", type=float, default=0.95)
args = parser.parse_args()
n_eps, seed, learn_rate, e_init, e_final, discount = args.episodes, args.seed, args.learn, args.e_init, args.e_final, args.discount
...
e_decay = (e_init-e_final) / n_eps * 2
