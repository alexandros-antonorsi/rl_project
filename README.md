...
#### Target Network
Mathematically, DQN aims to minimize the objective function $$ J(w)=\mathbb{E}\left[\left(R+\gamma \max_{a} q\left(S', a, w\right)-q(S, A, w)\right)^2\right] $$ 
